...
default['ls_sql_server']['sysadmins'] = "THEWALL.LOCAL\\SQL Admins"
default['ls_sql_server']['agent_account_pwd'] = 'super_secret_password'
default['ls_sql_server']['sql_account_pwd'] = 'super_secret_password'
default['ls_sql_server']['cluster'] = "standalone"
default['ls_windows_cluster']['cluster_name'] = "SQLtestCluster"
default['ls_windows_cluster']['cluster_ip_address'] = '10.0.0.3'
